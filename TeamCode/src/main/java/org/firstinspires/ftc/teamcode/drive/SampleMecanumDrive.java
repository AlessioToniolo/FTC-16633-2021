...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(0.65, 0, 0.05);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(2.0, 0, 0);
